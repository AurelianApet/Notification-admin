    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <table id="news_history" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Title</th>
                    ...
                    <a href="/notification_manage" class="btn btn-success btn-lg">Add News</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="">
                <div class="x_panel">
                    <div class="x_content">
                        <iframe id="newsContent" style="width:100%;min-height: 500px"></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    $('.preview').on('click',function(){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $('#newsContent').contents().find("body").html("");
                document.getElementById('newsContent').contentWindow.document.write(data.content);
            },
            fail: function(data){
